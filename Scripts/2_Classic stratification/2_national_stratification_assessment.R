...
estratificacion_3 = readRDS("./Data preparation/2_Classic stratification/1_National/stratification_3.rds")
estratificacion_4 = readRDS("./Data preparation/2_Classic stratification/1_National/stratification_4.rds")
estratificacion_5 = readRDS("./Data preparation/2_Classic stratification/1_National/stratification_5.rds")
...
aux_hg_3 <- data.frame(Percentiles = deff_datas(hogares_deff, "percentil", estratificacion_3, nombres_indicadores),
                        ...
                        Jarque = deff_datas(hogares_deff, "jarque", estratificacion_3, nombres_indicadores),
                        Kmeans = deff_datas(hogares_deff, "Kmeans", estratificacion_3, nombres_indicadores))
...
aux_hg_4 <- data.frame(Percentiles = deff_datas(hogares_deff, "percentil", estratificacion_4, nombres_indicadores),
                          ...
                          Jarque = deff_datas(hogares_deff, "jarque", estratificacion_4, nombres_indicadores),
                          Kmeans = deff_datas(hogares_deff, "Kmeans", estratificacion_4, nombres_indicadores))
...
aux_hg_5 <- data.frame(Percentiles = deff_datas(hogares_deff, "percentil", estratificacion_5, nombres_indicadores),
                          ...
                          geometric = deff_datas(hogares_deff, "geometric", estratificacion_5, nombres_indicadores),                          Jarque = deff_datas(hogares_deff, "jarque", estratificacion_5, nombres_indicadores),
                          Kmeans = deff_datas(hogares_deff, "Kmeans", estratificacion_5, nombres_indicadores))
...
aux_viv_3 <- data.frame(Percentiles=deff_datas(viviendas_deff, "percentil", estratificacion_3, nombres_indicadores),
                         ...
                         Jarque = deff_datas(viviendas_deff, "jarque", estratificacion_3, nombres_indicadores),
                         Kmeans = deff_datas(viviendas_deff, "Kmeans", estratificacion_3, nombres_indicadores))
...
aux_viv_4 <- data.frame(Percentiles=deff_datas(viviendas_deff, "percentil", estratificacion_4, nombres_indicadores),
                           ...
                           Jarque = deff_datas(viviendas_deff, "jarque", estratificacion_4, nombres_indicadores),
                           Kmeans = deff_datas(viviendas_deff, "Kmeans", estratificacion_4, nombres_indicadores))
...
aux_viv_5 <- data.frame(Percentiles=deff_datas(viviendas_deff, "percentil", estratificacion_5, nombres_indicadores),
                           ...
                           Jarque = deff_datas(viviendas_deff, "jarque", estratificacion_5, nombres_indicadores),
                           Kmeans = deff_datas(viviendas_deff, "Kmeans", estratificacion_5, nombres_indicadores))
...
aux_per_3 <- data.frame(Percentiles=deff_datas(personas_deff, "percentil", estratificacion_3, nombres_indicadores),
                         ...
                         Jarque = deff_datas(personas_deff, "jarque", estratificacion_3, nombres_indicadores),
                         Kmeans = deff_datas(personas_deff, "Kmeans", estratificacion_3, nombres_indicadores))
...
aux_per_4 <- data.frame(Percentiles=deff_datas(personas_deff, "percentil", estratificacion_4, nombres_indicadores),
                           ...
                           Jarque = deff_datas(personas_deff, "jarque", estratificacion_4, nombres_indicadores),
                           Kmeans = deff_datas(personas_deff, "Kmeans", estratificacion_4, nombres_indicadores))
...
aux_per_5 <- data.frame(Percentiles=deff_datas(personas_deff, "percentil", estratificacion_5, nombres_indicadores),
                           ...
                           Jarque = deff_datas(personas_deff, "jarque", estratificacion_5, nombres_indicadores),
                           Kmeans = deff_datas(personas_deff, "Kmeans", estratificacion_5, nombres_indicadores))
...
saveRDS(resumen_H3, "./Results/1_Classic stratification/1_National/deff_3.rds")
saveRDS(resumen_H4, "./Results/1_Classic stratification/1_National/deff_4.rds")
saveRDS(resumen_H5, "./Results/1_Classic stratification/1_National/deff_5.rds")

write.xlsx(resumen_H3, "./Results/1_Classic stratification/1_National/deff_3.xlsx")
write.xlsx(resumen_H4, "./Results/1_Classic stratification/1_National/deff_4.xlsx")
write.xlsx(resumen_H5, "./Results/1_Classic stratification/1_National/deff_5.xlsx")
