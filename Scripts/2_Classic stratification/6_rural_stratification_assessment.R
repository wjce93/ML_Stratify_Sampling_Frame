...
estratificacion_3 = readRDS("./Data preparation/2_Classic stratification/3_Rural/stratification_3.rds")
estratificacion_4 = readRDS("./Data preparation/2_Classic stratification/3_Rural/stratification_4.rds")
estratificacion_5 = readRDS("./Data preparation/2_Classic stratification/3_Rural/stratification_5.rds")
...
saveRDS(resumen_H3, "./Results/1_Classic stratification/3_Rural/deff_3.rds")
saveRDS(resumen_H4, "./Results/1_Classic stratification/3_Rural/deff_4.rds")
saveRDS(resumen_H5, "./Results/1_Classic stratification/3_Rural/deff_5.rds")

write.xlsx(resumen_H3, "./Results/1_Classic stratification/3_Rural/deff_3.xlsx")
write.xlsx(resumen_H4, "./Results/1_Classic stratification/3_Rural/deff_4.xlsx")
write.xlsx(resumen_H5, "./Results/1_Classic stratification/3_Rural/deff_5.xlsx")
