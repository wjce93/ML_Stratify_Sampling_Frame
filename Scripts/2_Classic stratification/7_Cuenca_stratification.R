...
saveRDS(variables_estratificacion, "./Data preparation/2_Classic stratification/4_Cuenca/stratification_variables.rds")
...
export(data, "./Data preparation/2_Classic stratification/4_Cuenca/cuenca_stratification_variables.csv")

# Guardar los resultados obtenidos de la estratificacion
saveRDS(resultado_global, "./Results/1_Classic stratification/4_Cuenca/cuenca_stratification_classic.rds")

# Guardar las estratificaciones
saveRDS(univariado_3, "./Data preparation/2_Classic stratification/4_Cuenca/stratification_3.rds")
saveRDS(univariado_4, "./Data preparation/2_Classic stratification/4_Cuenca/stratification_4.rds")
saveRDS(univariado_5, "./Data preparation/2_Classic stratification/4_Cuenca/stratification_5.rds")
