...
saveRDS(variables_estratificacion, "./Data preparation/2_Classic stratification/1_National/stratification_variables.rds")
...
export(data, "./Data preparation/2_Classic stratification/1_National/national_stratification_variables.csv")

# Guardar los resultados obtenidos de la estratificacion
saveRDS(resultado_global, "./Results/1_Classic stratification/1_National/national_stratification_classic.rds")

# Guardar las estratificaciones
saveRDS(univariado_3, "./Data preparation/2_Classic stratification/1_National/stratification_3.rds")
saveRDS(univariado_4, "./Data preparation/2_Classic stratification/1_National/stratification_4.rds")
saveRDS(univariado_5, "./Data preparation/2_Classic stratification/1_National/stratification_5.rds")
